...
Extend Agent Room from a provider-keyed two-agent conversation into configurable two- or three-participant sessions while preserving the existing provider adapter model.
