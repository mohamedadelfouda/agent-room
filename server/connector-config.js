const CONNECTOR_FIELDS = Object.freeze({
  gmail: [
    { id: "accessToken", label: "OAuth access token", env: "AGENT_ROOM_GMAIL_ACCESS_TOKEN", secret: true, max: 8192 },
  ],
  supabase: [
    { id: "url", label: "Project URL", env: "AGENT_ROOM_SUPABASE_URL", secret: false, max: 2048 },
    { id: "key", label: "API key", env: "AGENT_ROOM_SUPABASE_KEY", secret: true, max: 8192 },
  ],
});
