...
// API (`GET /api/setup/status`), a future `agent-room doctor` CLI, and diagnostics — one source of
...
// attached, trusted project, which is session-scoped and derived elsewhere. Agent Room's value is two
